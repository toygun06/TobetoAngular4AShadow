...
export class AuthService {
  // Subject'ler Observable'ın alt sınıfıdır. Kendi çağrılarımızı -next, error, complete yapabiliriz. Bu observable yapıya subscribe olan dinleyiciler, subscribe olduktan sonraki çağrıları alabilirler. // @Output'a benzer.
  ...
  logout(): void {
    ...
    // error(); // error: Observable'a hata ekler, artık yeni değer yayınlanmaz.
